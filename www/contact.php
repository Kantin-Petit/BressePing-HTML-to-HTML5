...
<html lang="fr"><head>
  ...
  <meta content="text/html; charset=ISO-8859-1" http-equiv="content-type"><title>Bresse-Ping--Formulaire contact</title>
...
<table class="fond_principal" style="text-align: left; width: 80%; margin-left: auto; margin-right: auto;" border="0" cellpadding="2" cellspacing="0">
  ...
  <tbody>
    <tr>
      ...
      <div id="titre_page">contact<br>
      <br>

      </div>

      <div><br>
Cette page vous permet de nous contacter pour une demande de
renseignements, ou tout simplement pour nous donner votre impression
sur ce site ou toute autre remarque, afin de l'améliorer. Merci! <br>
      <br>
